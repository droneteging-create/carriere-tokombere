...
map.getView().fit([1586141.024413, 1212869.679294, 1587174.601304, 1213645.593957], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte 01</h2>';
        return titleElement;
    })(),
